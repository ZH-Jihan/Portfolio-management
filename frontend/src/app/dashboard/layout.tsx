...
const sidebarItems = [
  {
    ...
    icon: <FileText />,
    subItems: [
      { name: "Create", path: "/dashboard/blog/create" },
      { name: "Update", path: "#" },
      { name: "Delete", path: "#" },
    ],
  },
  {
    ...
    icon: <Briefcase />,
    subItems: [
      { name: "Create", path: "/dashboard/experience/create" },
      { name: "Update", path: "#" },
      { name: "Delete", path: "#" },
    ],
  },
  {
    ...
    icon: <Folder />,
    subItems: [
      { name: "Create", path: "/dashboard/project/create" },
      { name: "Update", path: "#" },
      { name: "Delete", path: "#" },
    ],
  },
  {
    name: "Skill",
    icon: <Lightbulb />,
    subItems: [{ name: "Create", path: "/dashboard/skill/create" }],
  },
];
  ...
  return (
    <SidebarProvider>
      <div className="flex flex-col md:flex-row min-h-screen w-full bg-background">
        ...
        <Sidebar
          className={`$%7BisSidebarOpen%20?%20%22block%22%20:%20%22hidden%20md:flex%22%7D%20md:w-64%20bg-gray-800%20`}
        >
